...
void draw() {
  ...
  cut_ellipse(120, 120, 8, 8);
  cut_ellipse(120, 120, 20, 20);
  cut_ellipse(-120, 120, 8, 8);
  cut_ellipse(-120, 120, 20, 20);
  cut_ellipse(120,-120, 8, 8);
  cut_ellipse(120, -120, 20, 20);
  ...
  cut_noncircle_holes(hole_diameter, outer_cicle_diameter-20-i ,basis_anzahl -(i/4), i/14);
  }
  
  cut_noncircle_holes(hole_diameter, outer_cicle_diameter-20-80 ,basis_anzahl -(80/2), 40/14);
  cut_noncircle_holes(hole_diameter, outer_cicle_diameter-20-100 ,basis_anzahl -(80/2), 40/14);
  cut_noncircle_holes(hole_diameter, outer_cicle_diameter-20-120 ,basis_anzahl -(80/2), 40/14);
