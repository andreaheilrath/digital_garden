...
void draw() {
  ...
  for(int i = 1; i<7; i++){
    cut_regular_holes(hole_diameter, outer_cicle_diameter-66*i ,basis_anzahl*oberton_faktoren[i-1]);
  }
  ...
  cut_regular_holes(hole_diameter, outer_cicle_diameter-2*66-33 ,basis_anzahl*oberton_faktoren[1]-1);  
  
  cut_random_holes(hole_diameter, outer_cicle_diameter-3*66-33 , basis_anzahl*6, basis_anzahl*5);

  cut_regular_holes(hole_diameter, outer_cicle_diameter-4*66-33 ,basis_anzahl*4);
  cut_regular_holes(hole_diameter, outer_cicle_diameter-4*66-33 ,basis_anzahl*3);

  cut_random_holes(hole_diameter, outer_cicle_diameter-5*66-33 , basis_anzahl*5, basis_anzahl*3.3);
  
  cut_regular_holes(hole_diameter, outer_cicle_diameter-6*66-33 ,basis_anzahl*oberton_faktoren[6]-2); 
  
  cut_regular_holes(hole_diameter, outer_cicle_diameter-7*66 ,basis_anzahl*oberton_faktoren[6]-4); 
  
  cut_random_holes(hole_diameter, outer_cicle_diameter-7*66-33 , basis_anzahl*2, basis_anzahl*0.7);
